...
class Ventana_Normal:
    ...
    def get_parametros(self):
        ...
        self.mu_var = self.mu_entry.get()
        self.sigma_var = self.sigma_entry.get()
        ...
        print(self.tamanio_muestra, self.mu_var, self.sigma_var, self.intervalos_var)
    ...
    def mostrar_valores(self):
        ...
        muestra_label = tk.Label(self.root, text="Ingresa la cantidad de muestras a simular: ", anchor="w")
        ...
        mu_label = tk.Label(self.root, text="Ingresa el valor de mu: ", anchor="w")
        mu_label.grid(row=1, column=0, sticky="w")
        self.mu_entry = tk.Entry(self.root)  #
        self.mu_entry.grid(row=1, column=1)

        sigma_label = tk.Label(self.root, text="Ingresa el valor de sigma: ", anchor="w")
        sigma_label.grid(row=2, column=0, sticky="w")
        self.sigma_entry = tk.Entry(self.root)
        self.sigma_entry.grid(row=2, column=1)

        intervalos_label = tk.Label(self.root, text="Ingresa el numero de intervalos: ", anchor="w")
